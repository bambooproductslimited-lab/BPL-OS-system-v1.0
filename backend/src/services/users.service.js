...
async function list(ctx) {
  ...
  var res = await pool.query(
    'SELECT u.id, u.email, u.status, u.last_login_at, u.totp_enabled_at, e.first_name, e.last_name, ' +
  ...
  return res.rows.map(function (u) {
    return {
      id: u.id, email: u.email, status: u.status, lastLoginAt: u.last_login_at, twoStepOn: !!u.totp_enabled_at,
