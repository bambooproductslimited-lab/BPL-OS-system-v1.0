...
var PERMISSIONS = [
  ...
  { key: 'crm.read', group: 'Sales', label: 'View the CRM: leads, prospects, site visits' },
  { key: 'crm.manage', group: 'Sales', label: 'Add and work leads, prospects and site visits' },
  { key: 'crm.commission', group: 'Sales', label: "See everyone's commissions and mark them paid" }
];
