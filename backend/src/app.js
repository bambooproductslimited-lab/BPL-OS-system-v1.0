...
var shiftsRoutes = require('./routes/shifts.routes');
...
var stockSheetRoutes = require('./routes/stockSheet.routes');
var remindersRoutes = require('./routes/reminders.routes');
var smsRoutes = require('./routes/sms.routes');
var mailRoutes = require('./routes/mail.routes');
...
var restaurantPosRoutes = require('./routes/restaurantPos.routes');
var menuPhotosRoutes = require('./routes/menuPhotos.routes');
...
app.use('/api/stock-sheet', stockSheetRoutes);
...
app.use('/api/pos', restaurantPosRoutes);
